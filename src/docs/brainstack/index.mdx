...
- Evaluating locally: run the [Local proof](/docs/brainstack/local-proof/) before enrolling a real machine.
...
- Pilot review: read the [Trust model](/docs/brainstack/trust/) before exposing services or inviting more machines.
