---
title: Tyche Overview
description: Tyche gives teams deterministic agent simulations, comparisons, and replay bundles.
project: tyche
order: 1
---
...
Tyche should be treated as a design and pilot surface until a specific scenario pack exists. The first public docs should stay concrete: one scenario pack, one comparison run, one scorecard, and one replay bundle. Avoid broad claims about model quality without repeatable evidence.
